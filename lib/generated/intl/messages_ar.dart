...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(count) => "⭐ 4.9 (${count} تقييم)";

  static String m1(name) => "مرحباً، ${name}!";

  static String m2(index) => "العنصر ${index}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "fillProfileDescription": MessageLookupByLibrary.simpleMessage(
      "يرجى قضاء بضع دقائق لملء ملفك الشخصي بأكبر قدر ممكن من التفاصيل.",
    ),
    "fillYourProfile": MessageLookupByLibrary.simpleMessage("املأ ملفك الشخصي"),
    "findNearby": MessageLookupByLibrary.simpleMessage("البحث عن القريبين"),
    "forgotPassword": MessageLookupByLibrary.simpleMessage(
      "هل نسيت كلمة المرور؟",
    ),
    "forgotPasswordDescription": MessageLookupByLibrary.simpleMessage(
      "في تطبيقنا، نأخذ أمان معلوماتك على محمل الجد.",
    ),
